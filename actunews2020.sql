...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 17 nov. 2020 à 08:50
...
(6, 'Hugo', 'LIEGEARD', 'hugo@biyn.media', '$argon2id$v=19$m=65536,t=4,p=1$OFg3VTFrN0RjQ25Bakg0Rg$YLK2mL1GQILGCPFnu/NFkwO9+0G8nTyUNJacfMZ6WK8', 'a:1:{i:0;s:10:\"ROLE_ADMIN\";}', '2020-11-17 08:47:33', NULL),
(7, 'Karim', 'BOUFFAY', 'karim@graphikchannel.com', '$argon2id$v=19$m=65536,t=4,p=1$dkM1Ulg4V29aV294bnB4dw$uAtSQNDU77wtqJL5km5GezoW6QwBYq1uPj4ZYPh3c3c', 'a:1:{i:0;s:10:\"ROLE_ADMIN\";}', '2020-11-17 08:50:17', NULL);
